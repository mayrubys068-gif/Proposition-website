...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "You meant to press YES right, Danzo?🤨";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "Your hand must have slipped😥";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    text.innerHTML = "Gah, are you sure about that? 🤨😤";
    yes.style.height = "80%";
    yes.style.width = "80%";
    ...
    text.innerHTML = "Tsk tsk i'm not happy but it's whatever you desire my love 😭";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "YIPEEEEEEE DANALANGAA🤩❤️";
  yes.innerHTML = '<a href="https://www.instagram.com/may_92581">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
